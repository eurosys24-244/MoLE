...
from ..experts.ffn import FusedExpertsNetwork
...
class MOELayer(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        elif experts_type == 'ffn':
            self.experts = FusedExpertsNetwork(**experts, ctx=self)            
        else:
        ...
        for gi, single_gate_type in enumerate(gate_type):
            ...
            if gate_type == 'top':
                gate_module = LinearTopKGate(model_dim=self.model_dim, num_global_experts=self.num_global_experts, **single_gate_type)
            else:
