...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("mole_global_scatter", &_mole_global_scatter, "MoLE global scatter (CUDA)");
    m.def("mole_global_gather", &_mole_global_gather, "MoLE global gather (CUDA)");
    m.def("mole_global_scatter_all", &_mole_global_scatter_all, "MoLE global scatter (CUDA)");
    m.def("mole_global_gather_all", &_mole_global_gather_all, "MoLE global gather (CUDA)");
