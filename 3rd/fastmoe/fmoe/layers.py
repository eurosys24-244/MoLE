...
from .gates import NaiveGate, TutelGate
import tutel
...
def _tutel_style_fmoe_general_global_forward(inp, topk, gate_score, expert_fn, num_expert, world_size, capacity_factor, gate,**kwargs):
    r"""
...
if switch_from_env('FMOE_FASTER_SCHEDULE_ENABLE', False):
    ...
    from .fastermoe.schedule import _fmoe_general_global_forward, _tutel_style_fmoe_general_global_forward
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.emulate_mole = kwargs.get("emulate_mole", False)
    ...
    def forward(self, moe_inp):
        ...
        if self.tutel_style:
            fwd = _tutel_style_fmoe_general_global_forward(
                moe_inp, self.top_k, gate_score, self.expert_fn_single if fmoe_faster_schedule else self.expert_fn,
