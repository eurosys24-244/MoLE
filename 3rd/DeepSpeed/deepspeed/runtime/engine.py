...
from tutel.moe import moe_layer as tutel_moe_layer
from fairseq.modules.moe import MOELayer as fairseq_moe_layer
from fmoe import FMoETransformerMLP as fmoe_moe_layer
from mole.layer import moleLayer as mole_moe_layer
...
class DeepSpeedEngine(Module):
    ...
    def _configure_distributed_model(self, model):
        ...
        for _, module in self.module.named_modules():
            ...
            from transformers.models.switch_transformers import SwitchTransformersSparseMLP as switch_moe_layer
            if isinstance(module, MoE) or isinstance(module, tutel_moe_layer) or isinstance(module, fairseq_moe_layer) or isinstance(module, fmoe_moe_layer) or isinstance(module, mole_moe_layer) or (isinstance(module, switch_moe_layer) and module.use_ep):
